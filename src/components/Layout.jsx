...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex flex-col w-screen h-screen overflow-auto text-white bg-gray-900">
      <Header />
      {
          loading && <button disabled type="button" className="py-2.5 px-5 mr-2 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center">
            ...
            <div className="w-full px-10 mt-6">
              <div role="alert">
                ...
                <div class="border border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700">
                  <p>There was an error, please be patience</p>
                </div>
              </div>
            </div>
            </>
